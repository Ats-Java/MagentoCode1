...
// 			array('value' => 'random', 		'label' => Mage::helper('tablisting')->__('Random')),
			...
			//array('value' => 'created_at', 	'label' => Mage::helper('tablisting')->__('Date Created')),
			...
			array('value' => 'most_viewed',	'label' => Mage::helper('tablisting')->__('Popular Products')),
			array('value' => 'best_sales',	'label' => Mage::helper('tablisting')->__('Best Sales')),
		);
	}
}
